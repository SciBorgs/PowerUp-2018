 ...
 *
 */
public class AutoRaiseLiftToScaleCommand extends Command {

    public AutoRaiseLiftToScaleCommand() {
        requires(Robot.liftSubsystem);
    }

    // Called just before this Command runs the first time
    protected void initialize() {
    	Robot.liftSubsystem.liftTarget = LiftSubsystem.LiftTarget.ScaleHeight;
